...
# todo manxin rewrite pos_emb initial method
    ...
    def random_masking(self, x, mask_ratio):
        ...
        len_keep = int(L * (1 - mask_ratio))    #4050

        #print(len_keep)

        noise = torch.rand(N, L, device=x.device) + len_keep # noise in [0, 1]
        ...
        ids_keep = ids_shuffle[:, :len_keep]  #torch.Size([4, 4050])
    ...
    def forward_decoder(self, x, ids_restore):
        ...
        # add pos embed
        x = x_ + self.decoder_pos_embed+self.decoder_absolute_pos_embed
...
def mae_vit_base_patch16_dec512d8b(**kwargs):
    model = MaskedAutoencoderViT(
         embed_dim=768, depth=6, num_heads=4,
